...
void Viewer::init(int width, int height, CameraType cameratype, Shadertype shadertype, const char *title, const char* path) {
    // Initialize GLFW
    ...
    switch(cameratype) {
        ...
        case CameraType::ORTHOGRAPHIC:
            ...
            if(fx && fy && cx && cy)mcamera->setFromIntrinsics(fx, fy, cx, cy);
            break;
        default:
            mcamera = std::make_shared<PerspectiveCamera>();
    }
